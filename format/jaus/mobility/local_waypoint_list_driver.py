...
class Service(_jaus.Service):
    """
    Responsible for moving the platform given a series of target waypoints, desired travel speed, current pose,
    and current velocity state.

    The desired travel speed remains unchanged until a new ExecuteList is received.
    """
